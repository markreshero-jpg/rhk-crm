...
export default function SettingsTemplateDetailPage({
  ...
  if (error || !template) {
    return (
      <div className="p-10">
        ...
        <Link href="/settings/templates" className="text-sm underline mt-4 inline-block">Back to templates</Link>
      </div>
    )
  }
  ...
  return (
    <div className="p-10 max-w-[1400px]">
      ...
      <p className="text-[10px] uppercase tracking-widest text-text-subtle mb-2">Settings · Template</p>
